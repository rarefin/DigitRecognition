"""
 This data pre-processing script is taken from https://github.com/potterhsu/SVHNClassifier-PyTorch/blob/master/convert_to_lmdb.py

 to convert the raw data and labels files in mat format to the lmdb file format
